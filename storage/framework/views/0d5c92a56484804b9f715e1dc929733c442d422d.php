          ...
          <?php endif; ?>
            ...
            <div>
                ...
                <form action="/admin" method="post">
                    ...
                    <div class="p-2">
                    <input type="text" class="form-control" id="username_admin" name="username_admin" placeholder="Username" autofocus required>
                    </div>
                    <div class="p-2">
...
<?php /**PATH G:\Game\skripsi\viola\violalaundry - Copy (2)\resources\views/admin/login.blade.php ENDPATH**/ ?>