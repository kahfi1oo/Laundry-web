...
unset($__errorArgs, $__bag); ?>" id="nama" name="nama" placeholder="Nama" value="<?php echo e($t->data_user->nama); ?>" disabled="true">
...
unset($__errorArgs, $__bag); ?>" id="alamat" name="alamat" placeholder="Alamat" value="<?php echo e($t->data_user->alamat); ?>" disabled="true">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="row m-1">
            ...
            <div class="col">
                <select class="form-control mb-3 w-100" id="jns_barang" name="jns_barang" value="<?php echo e($t->jns_barang); ?>">
          ...
          <div class="row m-1">
            ...
            <div class="col">
                <select class="form-control mb-3 w-100" id="jns_jasa" name="jns_jasa" value="<?php echo e($t->jns_jasa); ?>">
                    <option>Cuci</option>
...
unset($__errorArgs, $__bag); ?>" id="jumlah_barang" name="jumlah_barang" value="<?php echo e($t->jumlah_barang); ?>">
...
unset($__errorArgs, $__bag); ?>" id="total_harga" name="total_harga" value="<?php echo e($t->total_harga); ?>">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="row m-1">
            ...
            <div class="col">
                <select class="form-control mb-3 w-100" id="status" name="status" value="<?php echo e($t->status); ?>">
...
<?php echo $__env->make('admin.mainadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Game\skripsi\viola\violalaundry - Copy (2)\resources\views/admin/editjob.blade.php ENDPATH**/ ?>