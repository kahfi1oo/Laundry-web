    ...
    <div class="card-body">
      <div class="dropdown">
        ...
        <form action="/laporminggu/cari" method="GET">
          <input type="week" class="btn card-title" name="cari" value="<?php echo e(old('cari')); ?>">
...
<?php echo $__env->make('admin.mainadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Game\skripsi\viola\violalaundry - Copy (2)\resources\views/admin/laporminggu.blade.php ENDPATH**/ ?>