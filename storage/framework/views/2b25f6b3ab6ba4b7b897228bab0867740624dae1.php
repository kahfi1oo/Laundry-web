      ...
      <div class="col-lg-10">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="mt-3 mx-2">
            <a href="/jobdone/hapus/<?php echo e($t->id); ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
            </div>
          </div>
...
<?php echo $__env->make('admin.mainadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Game\skripsi\viola\violalaundry - Copy (2)\resources\views/admin/jobdone.blade.php ENDPATH**/ ?>